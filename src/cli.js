...
if (argumento.length === 1) {
  MDlinks(argumento[0], { validate: false })
    .then(resp => {
    console.log(resp , 'No encontrada')
  })
}
...
if (argumento.length === 3) {
  if ((argumento[1] === '--validate' && argumento[2] === '--stats') || (argumento[1] === '--stats' && argumento[2] === '--validate' || (argumento[1] === '--s' && argumento[2] === '--v' )||(argumento[1] === '--v' && argumento[2] === '--s'))) {
